...
(function($) {
    ...
    var methods = {init: function(options) {
            ...
            return this.each(function() {
                ...
                if (!data) {
                    ...
                    $slider.data("slider", {target: $slider,options: options});

                    setInterval(function(){
                    	$slider.trigger("nextPage");
                    }, 3500); // Changes speed of the carousel
                }
            })
        },destroy: function() {
            return this.each(function() {
    ...
    $.fn.lemmonSlider.defaults = {items: "> *",loop: true,slideToLast: false,slider: "> *:first",infinite: false}
})($);
